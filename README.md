...
<img src="./screenshot.png" width="500"><img src="./screenshot2.png" width="500">
...
* I've added the AmigaPal logo to the drag and drop zone, but sadly still can't get the logo to replace the default Electron icon. Working on it.
